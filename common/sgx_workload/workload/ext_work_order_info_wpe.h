...
public:
    ...
    */
    ...
    /* Reserved function to sign a message with same key(s) that will be used to sign the workorder result.
       ...
       Parameters:
           ...
           wo_temp_verify_key_signature [OUT] - signature of the cancatenation
